    ...
    [
        ...
        [
            ...
            new Song(`Proverbs 26 24-25`, {
                ...
                longDescription: `Proverbs is a summary of the entire album's storyline. It is broken into five parts, each a homage to a real life person and the wrongdoing they commit against myself or my friend group.\n1. Shayne, "The Faker" - Pretended to be friends with Destin and enabled him to say harmful things about Lilly, then ratted him out to the school with video evidence to get him suspended.\n2. Natalie, "The Manipulator" - Tried multiple times to manipulate Emma into having sex with me at a very early time in our relationship.\n3. Lilly, "The Liar" - The mastermind behind all rumors spread about Clyde and Destin. She pried and struck at the people she disliked then denied all claims against her, fooling everyone with her innocence.\n4. Scottie, "The Allurer" - My first crush and Emma's ex-best-friend. After she began dating Tanner, I grew jealous enough to accidentally ignite the old fire in my heart, throwing my relationship with Emma into complete chaos and creating an even stronger hatred of Tanner. My turmoil of "who to love" shook me more than anything I've ever encountered in my life. At times, I was a soul watching my body make decisions I did not feel were correct, and sometimes I was a body without a soul, judged by a force that could not aid me.\n5. Tanner, "The Parasite" - The man who penetrated my friend group with lies and a facade of a personality. A deceiver who lies purely for sport. A man who deserves none of what he possesses, makes no effort to cherish it, and has the audacity to believe he deserves better. He manipulated me enough to make me reconsider my sense of mercy and I will never forgive him, no matter how much he changes. He is all that is evil and impure in myself. He is the type of person who will never change no matter how hard you try to help him because he does not want or need help. His actions are performed by his malicious mind alone, and it takes a master manipulator such as him to convince others that he needs their aid in helping him conquer his flaws. He is prideful, greedy, lustful, envious, gluttonous, wrathful, and lazy. He fakes, he manipulates, he lies, and he allures all who are ignorant enough to call him a friend, such as myself.\nIn the beginning of Scottie's part, a Latin chant can be heard: "Vale! Vale! Amator inanes!"\n"Vale" translates to "farewell," while "amator inanes" can translate to "empty lover," "lover of empty things," or "vain lover."\nAs such, this chant is a quadruple meaning in terms of interpretation.\n1. Farewell to myself, feeling hollow and confused from how to proceed with love (disassociation).\n2. Farewell to myself, who, in vain, either mistakenly loved someone or believed someone loved me.\n3. Farewell Scottie, whom I had a crush on but took interest in Tanner, an "empty" man.\n4. Farewell Scottie (and, by extension, Tanner), whose love is devoid of passion and therefore does not suit me.\nThe deliberate choice to have Emma sing the chant rather than myself was to emphasize the disassociation taking place throughout the album. I am no longer there to even speak for myself, and my partner is speaking on my behalf.\nIn the midst of Tanner's part, my own voice breaks the harsh musical textures to sing along one of Tanner's motifs:"We are one in the same. You think you aren't at blame. Well, after all of this shame, I'm the one you should hate."\nIt is here that the disassociation comes full circle, and now my voice represents both myself and Tanner simultaneously. The lyrics can be perceived as either party speaking to the other. The album as a whole puts both myself and Tanner to shame, and we are both compelled to hate each other for what we did to each other (that is, Tanner's double-crossing nature and the fact that I conveyed his sins through music, while also exposing my own problems).`,
                structure: [ 
