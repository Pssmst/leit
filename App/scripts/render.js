...
export function getTextWidth(ctx, text, font = global.font, fontSize = global.fontSize) {
...
export function drawText(
    ctx, text, {
        ...
        scaleY = 1,
        alpha = 1,
        verticalSpacing = global.verticalSpacing,
        weight = 'normal',
        outlineColor = '#000000',
        outlineWidth = 0,
    } = {}
...
export function drawBorder(ctx, x, y, width, height, color = "#ffffff") {
    ctx.strokeStyle = color;
...
export function drawCircle(
    ...
    if (strokeColor) {
        ...
        ctx.lineWidth = lineWidth;
        ctx.stroke();
        ctx.strokeStyle = "#ffffff"; // reset to default for consistency
    }
